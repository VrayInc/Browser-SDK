...
// Necessary JS Files
/////////////////////////
loadJSFile('https://cdn.jsdelivr.net/gh/VrayInc/Browser-SDK@Commercial-v1.3.12/js/jquery.min.js', jQueryAdded);
loadJSFile('https://cdn.jsdelivr.net/gh/VrayInc/Browser-SDK@Commercial-v1.3.12/js/paymentservices.js', paymentServicesAdded);
loadJSFile('https://cdn.jsdelivr.net/gh/VrayInc/Browser-SDK@Commercial-v1.3.12/js/chargeservices.js', chargeServicesAdded);
loadJSFile('https://cdn.jsdelivr.net/gh/VrayInc/Browser-SDK@Commercial-v1.3.12/js/digest.js', digestAdded);
loadJSFile('https://cdn.jsdelivr.net/gh/VrayInc/Browser-SDK@Commercial-v1.3.12/js/hmac-sha256.js', hmacAdded);
