...
{
    loadJSFile("https://cdn.jsdelivr.net/gh/VrayInc/Browser-SDK@v2.1.0/js/googleSignIn.js", googleSignInAdded);
}
...
function hmacAdded()
{
    loadJSFile('https://cdn.jsdelivr.net/gh/VrayInc/Browser-SDK@v2.1.0/js/enc-base64-min.js', encAdded);
}
...
var signupModalString =
    ...
    '<img src="https://cdn.jsdelivr.net/gh/VrayInc/Browser-SDK@v2.1.0/images/facebook.png" alt=""/>' +
    '<i>Sign Up with Facebook</i>' +
    '</button>' +
    '<button id="custom_google_btn" class="span2">' +
    '<img src="https://cdn.jsdelivr.net/gh/VrayInc/Browser-SDK@v2.1.0/images/google-logo.png" alt=""/>' +
...
var spinnerString =
    '<div id="waitForAuthorization" class="pay-with-mobile-spinner">' +
        ...
        '<img src="https://cdn.jsdelivr.net/gh/VrayInc/Browser-SDK@v2.1.0/images/spinner_green_dot.gif" width="50" height="50" class="proc-img"/>' +
    '</div>';

document.head.append(addCSSFile('https://cdn.jsdelivr.net/gh/VrayInc/Browser-SDK@v2.1.0/css/merchant-button-special.css'));
...
//////////////////////////////////
loadJSFile("https://cdn.jsdelivr.net/gh/VrayInc/Browser-SDK@v2.1.0/js/facebookSignIn.js", facebookSignInAdded);
