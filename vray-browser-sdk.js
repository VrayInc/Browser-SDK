...
// Necessary JS Files
/////////////////////////
loadJSFile('https://cdn.jsdelivr.net/gh/VrayInc/Commercial-v1.1.1/js/jquery.min.js', jQueryAdded);
loadJSFile('https://cdn.jsdelivr.net/gh/VrayInc/Commercial-v1.1.1/js/paymentservices.js', paymentServicesAdded);
loadJSFile('https://cdn.jsdelivr.net/gh/VrayInc/Commercial-v1.1.1/js/chargeservices.js', chargeServicesAdded);
loadJSFile('https://cdn.jsdelivr.net/gh/VrayInc/Commercial-v1.1.1/js/digest.js', digestAdded);
loadJSFile('https://cdn.jsdelivr.net/gh/VrayInc/Commercial-v1.1.1/js/hmac-sha256.js', hmacAdded);
