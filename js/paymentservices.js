...
var PAYMENT =
    {
        ...
        authorizationResponse: function(paymentResponse)
        {
            ...
            doMerchantCallback(TRANSACTION.id,  CARDHOLDER.id, MERCHANT.id, ccToken, TRANSACTION.amount); //doChargePayment
        ...
        {
            doMerchantCallback(tid,  CARDHOLDER.id, MERCHANT.id, token, TRANSACTION.amount);       //doChargePayment
                    ...
                    $.ajax(
                        {
                            ...
                            success: function(result)
                            {
                                ...
                                if (paymentResponse.status === STATUS.code.SUCCESS)
                                {
                                    ...
                                    doMerchantCallback(TRANSACTION.id,  CARDHOLDER.id, MERCHANT.id, ccToken, TRANSACTION.amount); // previously doChargePayment
                                }
                                else if  (paymentResponse.status === STATUS.code.Cancel)
                                {
                                    UTILS.errorDetected("Cancel");
