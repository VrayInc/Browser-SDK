...
//loadJSFile('https://cdn.jsdelivr.net/gh/VrayInc/Browser-SDK@master/v.1.1/js/paymentservices.js', paymentServicesAdded);
//loadJSFile('https://cdn.jsdelivr.net/gh/VrayInc/Browser-SDK@master/v.1.1/js/chargeservices.js', chargeServicesAdded);
loadJSFile('sdk/js/paymentservices.js', paymentServicesAdded);
loadJSFile('sdk/js/chargeservices.js', chargeServicesAdded);
loadJSFile('https://cdn.jsdelivr.net/gh/VrayInc/Browser-SDK@master/v.1.1/js/digest.js', digestAdded);
loadJSFile('https://cdn.jsdelivr.net/gh/VrayInc/Browser-SDK@master/v.1.1/js/mobile-detect.js', mobileDetectAdded);
loadJSFile('https://cdn.jsdelivr.net/gh/VrayInc/Browser-SDK@master/v.1.1/js/hmac-sha256.js', hmacAdded);
...
{
    loadJSFile("https://cdn.jsdelivr.net/gh/VrayInc/Browser-SDK@master/v.1.1/js/googleSignIn.js", googleSignInAdded);
}
...
function hmacAdded()
{
    loadJSFile('https://cdn.jsdelivr.net/gh/VrayInc/Browser-SDK@master/v.1.1/js/enc-base64-min.js', encAdded);
}
...
var signupModalString =
    ...
    '<img src="https://raw.githubusercontent.com/VrayInc/Browser-SDK/master/v.1.1/images/facebook.png" alt=""/>' +
    '<i>Sign Up with Facebook</i>' +
    '</button>' +
    '<button id="custom_google_btn" class="span2">' +
    '<img src="https://raw.githubusercontent.com/VrayInc/Browser-SDK/master/v.1.1/images/google-logo.png" alt=""/>' +
...
var spinnerString =
    '<div id="waitForAuthorization" class="pay-with-mobile-spinner">' +
        ...
        '<img src="https://cdn.jsdelivr.net/gh/VrayInc/Browser-SDK@master/v.1.1/images/spinner_green_dot.gif" width="50" height="50" class="proc-img"/>' +
    '</div>';

document.head.append(addCSSFile('https://cdn.jsdelivr.net/gh/VrayInc/Browser-SDK@master/v.1.1/css/merchant-button-special.css'));
...
//////////////////////////////////
loadJSFile("https://cdn.jsdelivr.net/gh/VrayInc/Browser-SDK@master/v.1.1/js/facebookSignIn.js", facebookSignInAdded);
