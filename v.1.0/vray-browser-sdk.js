...
{
    loadJSFile("https://rawgit.com/VrayInc/Browser-SDK/mulletsocks/v.1.0/js/googleSignIn.js", googleSignInAdded);
}
...
function hmacAdded()
{
    loadJSFile('https://rawgit.com/VrayInc/Browser-SDK/mulletsocks/v.1.0/js/enc-base64-min.js', encAdded);
}
...
var spinnerString =
    '<div id="waitForAuthorization" class="pay-with-mobile-spinner">' +
        ...
        '<img src="https://raw.githubusercontent.com/VrayInc/Browser-SDK/mulletsocks/v.1.0/images/spinner_green_dot.gif" width="50" height="50" class="proc-img"/>' +
    '</div>';

document.head.append(addCSSFile('https://rawgit.com/VrayInc/Browser-SDK/mulletsocks/v.1.0/css/merchant-button-special.css'));
...
//////////////////////////////////
loadJSFile("https://rawgit.com/VrayInc/Browser-SDK/mulletsocks/v.1.0/js/facebookSignIn.js", facebookSignInAdded);
